...
public class UploadDataListener<T> extends AnalysisEventListener<T> {
     ...
     *
     * @param uploadInsertMapper uploadInsertMapper
     */
    public UploadDataListener(UploadInsertMapper uploadInsertMapper) {
        this.uploadInsertMapper = uploadInsertMapper;
    }
